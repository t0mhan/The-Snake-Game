...
function startGame(){
    ...
    gameState = 'play';
    snake = new Snake();
    setJelloShots(5);//number of food appears on screen
    loop();
}
...
function endGame(){
    ...
    startBtn = createButton('Restart Your Game');
...
//number of food(green squares) that appears on screen
...
//what haapens when snake touches itsels or walls
